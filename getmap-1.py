...
zoom = 5  # 下载切片的zoom
lefttop = deg2num(50.1, 70, zoom)  # 下载切片的左上角角点
rightbottom = deg2num(12, 145, zoom)
#lefttop = deg2num(106, 29, zoom)  # 下载切片的左上角角点
#rightbottom = deg2num(105, 30, zoom)
...
rootDir = "c:\\Download\\tiandituImgLabel\\"
...
for x in range(lefttop[0], rightbottom[0]):
    for y in range(lefttop[1], rightbottom[1]):
        ...
        # 天地图-影像标注
        #tilepath = 'http://t2.tianditu.gov.cn/DataServer?T=cia_w&x=' + str(x) + '&y=' + str(y) + '&l=' + str(
        #    zoom) + '&tk=2ce94f67e58faa24beb7cb8a09780552'
